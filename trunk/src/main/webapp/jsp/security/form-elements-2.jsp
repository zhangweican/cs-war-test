...
<html lang="en"><%@ include file="../common/head.jsp" %>
	<head>
		...
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/bootstrap-duallistbox.css" />
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/bootstrap-multiselect.css" />
...
<![endif]-->
		...
		<script src="${cxt}/plugins/assets/js/jquery.bootstrap-duallistbox.js"></script>
		<script src="${cxt}/plugins/assets/js/jquery.raty.js"></script>
		<script src="${cxt}/plugins/assets/js/bootstrap-multiselect.js"></script>
		<script src="${cxt}/plugins/assets/js/select2.js"></script>
		<script src="${cxt}/plugins/assets/js/typeahead.jquery.js"></script>
