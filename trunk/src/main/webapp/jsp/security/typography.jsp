...
<html lang="en"><%@ include file="../common/head.jsp" %>
	<head>
		...
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/prettify.css" />
...
<![endif]-->
		...
		<script src="${cxt}/plugins/assets/js/prettify.js"></script>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$('#id-check-horizontal').removeAttr('checked').on('click', function(){
					$('#dt-list-1').toggleClass('dl-horizontal').prev().jspp(this.checked ? '&lt;dl class="dl-horizontal"&gt;' : '&lt;dl&gt;');
				});
