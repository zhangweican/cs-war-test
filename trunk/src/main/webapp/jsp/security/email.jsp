...
<html lang="en"><%@ include file="../common/head.jsp" %>
	...
	converts normal Bootstrap HTML to email friendly table layout with inline CSS!
								...
								<div class="row">
									<div class="col-xs-3">
										<a href="../build/demo/email-confirmation.jsp" class="thumbnail" target="_blank">
											<img class="img-responsive" src="${cxt}/plugins/assets/images/email1.png" alt="Email Template" />
										</a>
									</div>

									<div class="col-xs-3">
										<a href="../build/demo/email-navbar.jsp" class="thumbnail" target="_blank">
											<img class="img-responsive" src="${cxt}/plugins/assets/images/email2.png" alt="Email Template" />
										</a>
									</div>

									<div class="col-xs-3">
										<a href="../build/demo/email-newsletter.jsp" class="thumbnail" target="_blank">
											<img class="img-responsive" src="${cxt}/plugins/assets/images/email3.png" alt="Email Template" />
										</a>
									</div>

									<div class="col-xs-3">
										<a href="../build/demo/email-contrast.jsp" class="thumbnail" target="_blank">
