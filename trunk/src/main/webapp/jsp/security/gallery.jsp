				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								Gallery <fmt:message key="password.label" />
								<small>
							...
							<div class="col-xs-12">
								...
								<div>
									<ul class="ace-thumbnails clearfix">
										...
										<li>
											<a href="${cxt}/plugins/assets/images/gallery/image-1.jpg" title="Photo Title" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-1.jpg" />
											</a>
										...
										<li>
											<a href="${cxt}/plugins/assets/images/gallery/image-2.jpg" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-2.jpg" />
												<div class="text">
										...
										<li>
											<a href="${cxt}/plugins/assets/images/gallery/image-3.jpg" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-3.jpg" />
												<div class="text">
													<div class="inner">Sample Caption on Hover</div>
												</div>
											</a>
										...
										<!-- /section:pages/gallery.caption -->
										<li>
											<a href="${cxt}/plugins/assets/images/gallery/image-4.jpg" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-4.jpg" />
												<div class="tags">
										...
										<li>
											<div>
												<img width="150" height="150" alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-5.jpg" />
												<div class="text">
													<div class="inner">
														<span>Some Title!</span>

														<br />
														<a href="${cxt}/plugins/assets/images/gallery/image-5.jpg" data-rel="colorbox">
										...
										<li>
											<a href="${cxt}/plugins/assets/images/gallery/image-6.jpg" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-6.jpg" />
											</a>
										...
										<li>
											<a href="${cxt}/plugins/assets/images/gallery/image-1.jpg" data-rel="colorbox">
												<img width="150" height="150" alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-1.jpg" />
											</a>
...
>>>>>>> origin/master
	...
	$("#cboxLoadingGraphic").jspp("<i class='ace-icon fa fa-spinner orange fa-spin'></i>");//let's add a custom loading icon
