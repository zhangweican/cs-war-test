...
<html lang="en"><%@ include file="../common/head.jsp" %>
	<head>
		...
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/jquery-ui.custom.css" />
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/jquery.gritter.css" />
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/select2.css" />
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/datepicker.css" />
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/bootstrap-editable.css" />
										...
										<div class="col-xs-12 col-sm-3 center">
											<div>
												...
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="${cxt}/plugins/assets/avatars/profile-pic.jpg" />
												</span>
													...
													<div class="widget-main padding-8">
														...
														<div id="profile-feed-1" class="profile-feed">
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="Alex Doe's avatar" src="${cxt}/plugins/assets/avatars/avatar5.png" />
															...
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="Susan Smith's avatar" src="${cxt}/plugins/assets/avatars/avatar1.png" />
															...
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="David Palms's avatar" src="${cxt}/plugins/assets/avatars/avatar4.png" />
											...
											<div class="tab-content no-border padding-24">
												<div id="home" class="tab-pane in active">
													<div class="row">
														<div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																<img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="${cxt}/plugins/assets/avatars/profile-pic.jpg" />
															</span>
													...
													<div class="profile-users clearfix">
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${cxt}/plugins/assets/avatars/avatar4.png" alt="Bob Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${cxt}/plugins/assets/avatars/avatar1.png" alt="Rose Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${cxt}/plugins/assets/avatars/avatar.png" alt="Jim Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${cxt}/plugins/assets/avatars/avatar5.png" alt="Alex Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${cxt}/plugins/assets/avatars/avatar2.png" alt="Phil Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${cxt}/plugins/assets/avatars/avatar3.png" alt="Susan Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${cxt}/plugins/assets/avatars/avatar1.png" alt="Jennifer Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="${cxt}/plugins/assets/avatars/avatar3.png" alt="Alexa Doe's avatar" />
																	</a>
																</div>
													...
													<ul class="ace-thumbnails">
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-1.jpg" />
																<div class="text">
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-2.jpg" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-3.jpg" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-4.jpg" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-5.jpg" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="${cxt}/plugins/assets/images/gallery/thumb-6.jpg" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
...
<![endif]-->
		...
		<script src="${cxt}/plugins/assets/js/jquery.gritter.js"></script>
		<script src="${cxt}/plugins/assets/js/bootbox.js"></script>
		<script src="${cxt}/plugins/assets/js/jquery.easypiechart.js"></script>
		<script src="${cxt}/plugins/assets/js/date-time/bootstrap-datepicker.js"></script>
		<script src="${cxt}/plugins/assets/js/jquery.hotkeys.js"></script>
		<script src="${cxt}/plugins/assets/js/bootstrap-wysiwyg.js"></script>
		<script src="${cxt}/plugins/assets/js/select2.js"></script>
		<script src="${cxt}/plugins/assets/js/fuelux/fuelux.spinner.js"></script>
		<script src="${cxt}/plugins/assets/js/x-editable/bootstrap-editable.js"></script>
		<script src="${cxt}/plugins/assets/js/x-editable/ace-editable.js"></script>
			    ...
			    $('#login').editable({
					...
					success: function(response, newValue) {
						if(parseInt(newValue) == 1)
							$(this).jspp(newValue + " hour ago");
						else $(this).jspp(newValue + " hours ago");
					}
				});
