...
<html lang="en"><%@ include file="../common/head.jsp" %>
	<head>
		...
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/chosen.css" />
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/datepicker.css" />
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/bootstrap-timepicker.css" />
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/daterangepicker.css" />
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/bootstrap-datetimepicker.css" />
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/colorpicker.css" />
...
<![endif]-->
		...
		<script src="${cxt}/plugins/assets/js/chosen.jquery.js"></script>
		...
		<script src="${cxt}/plugins/assets/js/date-time/bootstrap-timepicker.js"></script>
		<script src="${cxt}/plugins/assets/js/date-time/moment.js"></script>
		<script src="${cxt}/plugins/assets/js/date-time/daterangepicker.js"></script>
		<script src="${cxt}/plugins/assets/js/date-time/bootstrap-datetimepicker.js"></script>
		<script src="${cxt}/plugins/assets/js/bootstrap-colorpicker.js"></script>
		<script src="${cxt}/plugins/assets/js/jquery.knob.js"></script>
		<script src="${cxt}/plugins/assets/js/jquery.autosize.js"></script>
		<script src="${cxt}/plugins/assets/js/jquery.inputlimiter.1.3.1.js"></script>
		<script src="${cxt}/plugins/assets/js/jquery.maskedinput.js"></script>
		<script src="${cxt}/plugins/assets/js/bootstrap-tag.js"></script>
