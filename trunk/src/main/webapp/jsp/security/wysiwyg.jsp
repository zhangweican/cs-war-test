...
- list item 3</textarea>
								...
								<script type="text/javascript">
									var $path_assets = "${cxt}/plugins/assets";//this will be used in loading jQuery UI if needed!
								</script>
...
<![endif]-->
		...
		<script src="${cxt}/plugins/assets/js/markdown/markdown.js"></script>
		<script src="${cxt}/plugins/assets/js/markdown/bootstrap-markdown.js"></script>
