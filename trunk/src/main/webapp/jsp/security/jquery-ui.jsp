							...
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>
											Please see
											<a href="form-elements.jspp">form elements page</a>
...
<![endif]-->
		...
		<script src="${cxt}/plugins/assets/js/jquery-ui.js"></script>
			...
			*/
				...
				var spinner = $( "#spinner" ).spinner({
					create: function( event, ui ) {
						...
						$(this)
						.next().addClass('btn btn-success').jspp('<i class="ace-icon fa fa-plus"></i>')
						.next().addClass('btn btn-danger').jspp('<i class="ace-icon fa fa-minus"></i>')
