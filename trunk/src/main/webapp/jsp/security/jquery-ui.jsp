							...
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>
											Please see
											<a href="form-elements.jsp">form elements page</a>
			...
			*/
				...
				var spinner = $( "#spinner" ).spinner({
					create: function( event, ui ) {
						...
						$(this)
						.next().addClass('btn btn-success').jsp('<i class="ace-icon fa fa-plus"></i>')
						.next().addClass('btn btn-danger').jsp('<i class="ace-icon fa fa-minus"></i>')
