...
<html lang="en"><%@ include file="../common/head.jsp" %>
	<head>
		...
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/jquery-ui.css" />
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/datepicker.css" />
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/ui.jqgrid.css" />
...
<![endif]-->
		...
		<script src="${cxt}/plugins/assets/js/jqGrid/jquery.jqGrid.src.js"></script>
		<script src="${cxt}/plugins/assets/js/jqGrid/i18n/grid.locale-en.js"></script>
