...
<html lang="en"><%@ include file="../common/head.jsp" %>
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/ace.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="${cxt}/plugins/assets/css/ace-part2.css" />
		<![endif]-->
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/ace-rtl.css" />
