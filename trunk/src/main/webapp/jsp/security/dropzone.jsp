...
<html lang="en"><%@ include file="../common/head.jsp" %>
	<head>
		...
		<link rel="stylesheet" href="${cxt}/plugins/assets/css/dropzone.css" />
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div>
									<form action="../dummy.jspp" class="dropzone" id="dropzone">
										<div class="fallback">
...
<![endif]-->
		...
		<script src="${cxt}/plugins/assets/js/dropzone.js"></script>
